...
def build_transformer(src_vocab_size:int, tgt_vocab_size: int, tgt_seq_len: int, src_seq_len: int, d_model: int = 512, N: int = 6, h: int = 8, dropout: float = 0.1, d_ff = 2048):
